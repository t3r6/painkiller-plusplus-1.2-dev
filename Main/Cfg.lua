...
function Cfg:SetMaps()
	self.ServerMapsFFA = {"C2L5_Town","DM_Mine","DM_Illuminati","DM_Cursed","DM_Sacred","DM_Psycho","DM_Fragenstein","DM_Factory","DM_Trainstation","DM_Fallen1","DM_Fallen2"}
	self.ServerMapsTDM = {"DM_Mine","DM_Illuminati","DM_Cursed","DM_Sacred","DM_Psycho","DM_Fragenstein","DM_Factory","DM_Trainstation","DM_Fallen1","DM_Fallen2"}
	self.ServerMapsTLB = {"DM_Mine","DM_Illuminati","DM_Cursed","DM_Sacred","DM_Psycho","DM_Fragenstein","DM_Factory","DM_Trainstation","DM_Fallen1","DM_Fallen2"}
	self.ServerMapsPCF = {"DMPCF_Tower","DMPCF_Warehouse","DM_Mine","DM_Illuminati","DM_Cursed","DM_Sacred","DM_Psycho","DM_Fragenstein","DM_Factory","DM_Trainstation","DM_Fallen1","DM_Fallen2"}
	self.ServerMapsVSH = {"DM_Mine","DM_Illuminati","DM_Cursed","DM_Sacred","DM_Psycho","DM_Fragenstein","DM_Factory","DM_Trainstation","DM_Fallen1","DM_Fallen2"}
	self.ServerMapsCTF = {"CTF_Forbidden","CTF_Chaos","CTF_Trainstation"}
	self.ServerMapsDUE = {"DM_Mine","DM_Illuminati","DM_Cursed","DM_Sacred","DM_Psycho","DM_Fragenstein","DM_Factory","DM_Trainstation","DM_Fallen1","DM_Fallen2"}
	self.ServerMapsLMS = {"DM_Mine","DM_Illuminati","DM_Cursed","DM_Sacred","DM_Psycho","DM_Fragenstein","DM_Factory","DM_Trainstation","DM_Fallen1","DM_Fallen2"}
	self.ServerMapsCLA = {"DM_Mine","DM_Illuminati","DM_Cursed","DM_Sacred","DM_Psycho","DM_Fragenstein","DM_Factory","DM_Trainstation","DM_Fallen1","DM_Fallen2"}
end
Cfg:SetMaps()
...
function Cfg:Check()
	...
	Cfg.ShowWaypoints = Cfg:CheckVar(Cfg.ShowWaypoints,"b")
	Cfg.ShowWaypoints = Cfg:CheckVar(Cfg.ShowWaypoints,"b")
	Cfg.ShowWaypoints = Cfg:CheckVar(Cfg.ShowWaypoints,"b")
	Cfg.ShowWaypoints = Cfg:CheckVar(Cfg.ShowWaypoints,"b")
	Cfg.ShowWaypoints = Cfg:CheckVar(Cfg.ShowWaypoints,"b")
