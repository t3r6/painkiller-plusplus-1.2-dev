...
Game =
{
	...
	-- game info
	GMode = GModes.MultiplayerServer,
	CheckPoint = 0,
...
function Game:Init(nolevel)
	...
	CAM.EnableInterpolation(false)--Cfg.CameraInterpolation
	SOUND.SetSoundSpeedRandomizer(Cfg.DisturbSound3DFreq)
	if SoundsProperties then
...
function Game:Render(delta) -- do HUD'a
	...
	--if Cfg.ShowHide then
		--Game:ShowHide(WORLD.GetEntityList(ETypes.Model))
		--Game:ShowHide(WORLD.GetEntityList(ETypes.Region))
		--Game:ShowHide(WORLD.GetEntityList(ETypes.Billboard))
		--Game:ShowHide(WORLD.GetEntityList(ETypes.Environment))
		--Game:ShowHide(WORLD.GetEntityList(ETypes.Light))
		--Game:ShowHide(WORLD.GetEntityList(ETypes.Decal))
		--if Cfg.ShowHidePrint then
		--CONSOLE_AddMessage("Thingies SHOWN ("..tostring(Game.shown)..") | Thingies HIDDEN ("..tostring(Game.hidden)..")") end
		--Game.hidden = 0
		--Game.shown = 0
	--end
end
...
function Game:Print(str)
	CONSOLE_AddMessage("#7Game:Print #5"..string.format("%.2f",(self.currentTime / 30))..": "..str)
	...
	for i=1,table.getn(files) do
		...
		if ext ~= "CLevel" then
			...
			if o and Game.GMode == GModes.DedicatedServer then
				if fx then o._DeleteAfterCache = true end
				--if o._Class == "CActor" then o._DeleteAfterCache = true end
				
			end
			
			if o.BaseObj == "Slab.CItem"  then o = nil end
			--if o._Class == "CActor" then o = nil end
			
			if o and Game.GMode == GModes.MultiplayerClient then
				o._DeleteAfterCache = true
				if o.BaseObj == "JumpPad.CItem"  then o._DeleteAfterCache = false end
				if o.BaseObj == "Teleport.CBox"  then o._DeleteAfterCache = false end
				if o._Class == "CArea" then o._DeleteAfterCache = false end
				if fx and o.VisibleOnMPClient then o._DeleteAfterCache = false end
			end
			...
			if o and o._DeleteAfterCache == true then o = nil end
			if o then
				if o.OnInitTemplate then o:OnInitTemplate() end
...
function Game:thing()
	if o and o._Class == "CActor" then o = nil end

			if o and o.BaseObj == "AmbushForPlayer.CBox" then o = nil end
			if o and o.BaseObj == "CheckPoint.CItem" then o = nil end
			--if o and o.BaseObj == "Slab.CItem" then o:Open(false) o:Delete() o.BaseObj = "Coffin.CBox" end

			-- TREASURES
			if o and o.BaseObj == "CoinG.CItem" then o = nil end
			if o and o.BaseObj == "CoinG.CItem" then o = nil end
			if o and o.BaseObj == "CoinS.CItem" then o = nil end
			if o and o.BaseObj == "Cup1.CItem" then o = nil end
			if o and o.BaseObj == "Cup2.CItem" then o = nil end
			if o and o.BaseObj == "DoorKey.CItem" then o = nil end
			if o and o.BaseObj == "Host1.CItem" then o = nil end
			if o and o.BaseObj == "Host2.CItem" then o = nil end
			if o and o.BaseObj == "pentakl.CItem" then o = nil end
			if o and o.BaseObj == "RingR.CItem" then o = nil end
			if o and o.BaseObj == "RingG.CItem" then o = nil end
			if o and o.BaseObj == "RingB.CItem" then o = nil end
			if o and o.BaseObj == "StoneR.CItem" then o = nil end
			if o and o.BaseObj == "StoneG.CItem" then o = nil end
			if o and o.BaseObj == "StoneB.CItem" then o = nil end
			...
			if o and o.BaseObj == "AC_Door1" then o = nil end
			if o and o.BaseObj == "AC_Grate" then o = nil end
			if o and o.BaseObj == "AC_Lamp1" then o = nil end
			if o and o.BaseObj == "AmmoBox" then o = nil end
			if o and o.BaseObj == "AmmoBoxSmall" then o = nil end
			if o and o.BaseObj == "Automat" then o = nil end
			if o and o.BaseObj == "Ball" then o = nil end
			if o and o.BaseObj == "baniaki" then o = nil end
			if o and o.BaseObj == "Bankomat" then o = nil end
			if o and o.BaseObj == "Barrack" then o = nil end
			if o and o.BaseObj == "BarrelBig" then o = nil end
			if o and o.BaseObj == "BarrelSmall" then o = nil end
			if o and o.BaseObj == "Barrel_arab" then o = nil end
			if o and o.BaseObj == "beczka" then o = nil end
			if o and o.BaseObj == "beczka2" then o = nil end
			if o and o.BaseObj == "beczka_met" then o = nil end
			if o and o.BaseObj == "beczka_met_zardz" then o = nil end
			if o and o.BaseObj == "Benzyna_Baniak" then o = nil end
			if o and o.BaseObj == "Benzyna_Bok" then o = nil end
			if o and o.BaseObj == "Benzyna_Kolek" then o = nil end
			if o and o.BaseObj == "Benzyna_Spod" then o = nil end
			if o and o.BaseObj == "brama" then o = nil end
			if o and o.BaseObj == "butla" then o = nil end
			if o and o.BaseObj == "C1L3_Blokada" then o = nil end
			if o and o.BaseObj == "C1L3_korzenie" then o = nil end
			if o and o.BaseObj == "C1L3_uapka" then o = nil end
			if o and o.BaseObj == "C1L4_TrupA" then o = nil end
			if o and o.BaseObj == "C1L4_TrupB" then o = nil end
			if o and o.BaseObj == "C2L1_Belka" then o = nil end
			if o and o.BaseObj == "C2L1_Drezynka" then o = nil end
			if o and o.BaseObj == "C2L1_Panel" then o = nil end
			if o and o.BaseObj == "C2L1_Wagonik" then o = nil end
			if o and o.BaseObj == "C2L1_Winda" then o = nil end
			if o and o.BaseObj == "C2L2_Chain1" then o = nil end
			if o and o.BaseObj == "C2L2_Door1" then o = nil end
			if o and o.BaseObj == "C2L2_Door2" then o = nil end
			if o and o.BaseObj == "C2L2_Door3" then o = nil end
			if o and o.BaseObj == "C2L2_Fan" then o = nil end
			if o and o.BaseObj == "C2L2_Kladka1" then o = nil end
			if o and o.BaseObj == "C2L2_Lamp1" then o = nil end
			if o and o.BaseObj == "C2L2_Lamp2" then o = nil end
			if o and o.BaseObj == "C2L2_Pokrywa" then o = nil end
			if o and o.BaseObj == "C2L2_switch" then o = nil end
			if o and o.BaseObj == "C2L3_Gun1" then o = nil end
			if o and o.BaseObj == "C2L3_Zyrandol1" then o = nil end
			if o and o.BaseObj == "C2L4_drzwigora" then o = nil end
			if o and o.BaseObj == "C2L4_drzwiparter" then o = nil end
			if o and o.BaseObj == "C2L4_drzwisrodek" then o = nil end
			if o and o.BaseObj == "C2L5_Balkonik" then o = nil end
			if o and o.BaseObj == "C2L5_klatka" then o = nil end
			if o and o.BaseObj == "C2L5_Lina1" then o = nil end
			if o and o.BaseObj == "C2L5_Okiennica" then o = nil end
			if o and o.BaseObj == "C2L5_Okno1" then o = nil end
			if o and o.BaseObj == "C2L5_Szyld1" then o = nil end
			if o and o.BaseObj == "C2L5_Szyld2" then o = nil end
			if o and o.BaseObj == "C2L5_Wozek" then o = nil end
			if o and o.BaseObj == "C3L1_Fan" then o = nil end
			if o and o.BaseObj == "C3L1_LampA" then o = nil end
			if o and o.BaseObj == "C3L1_LampB" then o = nil end
			if o and o.BaseObj == "C3L1_LampC" then o = nil end
			if o and o.BaseObj == "C3L1_LampD" then o = nil end
			if o and o.BaseObj == "C3L1_LampE" then o = nil end
			if o and o.BaseObj == "C3L1_Stand" then o = nil end
			if o and o.BaseObj == "C3L1_Wagon_Drzwi" then o = nil end
			if o and o.BaseObj == "C3L2_HakA" then o = nil end
			if o and o.BaseObj == "C3L2_HakB" then o = nil end
			if o and o.BaseObj == "C3L2_HakC" then o = nil end
			if o and o.BaseObj == "C3L2_wieko1" then o = nil end
			if o and o.BaseObj == "C3L2_wieko2" then o = nil end
			if o and o.BaseObj == "C3L2_wieko8" then o = nil end
			if o and o.BaseObj == "C3L3_Brama" then o = nil end
			if o and o.BaseObj == "C3L3_Podstawka" then o = nil end
			if o and o.BaseObj == "C3L3_SilosCover" then o = nil end
			if o and o.BaseObj == "C3L3_Truck" then o = nil end
			if o and o.BaseObj == "C3L4_balista" then o = nil end
			if o and o.BaseObj == "C3L4_katapulta" then o = nil end
			if o and o.BaseObj == "C3L4_taran" then o = nil end
			if o and o.BaseObj == "C3L6_Mostek" then o = nil end
			if o and o.BaseObj == "C4L1_Fireworks_sack" then o = nil end
			if o and o.BaseObj == "C4L1_Fireworks_stick1" then o = nil end
			if o and o.BaseObj == "C4L1_Fireworks_stick2" then o = nil end
			if o and o.BaseObj == "C4L1_Fireworks_stick3" then o = nil end
			if o and o.BaseObj == "C4L1_Fireworks_stick4" then o = nil end
			if o and o.BaseObj == "C4L1_Fireworks_stick5" then o = nil end
			if o and o.BaseObj == "C4L1_fontain" then o = nil end
			if o and o.BaseObj == "C4L1_Lamp" then o = nil end
			if o and o.BaseObj == "C4L1_Lava" then o = nil end
			if o and o.BaseObj == "C4L1_SkullFireball" then o = nil end
			if o and o.BaseObj == "C4L1_skulls" then o = nil end
			if o and o.BaseObj == "C4L2_Lampa" then o = nil end
			if o and o.BaseObj == "C5L2_Crane" then o = nil end
			if o and o.BaseObj == "C5L2_Hak1" then o = nil end
			if o and o.BaseObj == "C5L2_Hak2" then o = nil end
			if o and o.BaseObj == "C5L2_Hak3" then o = nil end
			if o and o.BaseObj == "C5L2_Hak4" then o = nil end
			if o and o.BaseObj == "C5L2_Komin" then o = nil end
			if o and o.BaseObj == "C5L2_Kont1" then o = nil end
			if o and o.BaseObj == "C5L2_Kont2" then o = nil end
			if o and o.BaseObj == "C5L2_Kont3" then o = nil end
			if o and o.BaseObj == "C5L2_Kont4" then o = nil end
			if o and o.BaseObj == "C5L2_Kont7" then o = nil end
			if o and o.BaseObj == "C5L2_Tir" then o = nil end
			if o and o.BaseObj == "C5L2_Winda" then o = nil end
			if o and o.BaseObj == "C5L3_Krzyz" then o = nil end
			if o and o.BaseObj == "C6L1_Car_doska_green" then o = nil end
			if o and o.BaseObj == "C6L1_Car_doska_green_alarm" then o = nil end
			if o and o.BaseObj == "C6L1_Car_doska_green_gib" then o = nil end
			if o and o.BaseObj == "C6L1_Car_doska_green_kolka" then o = nil end
			if o and o.BaseObj == "C6L1_Car_doska_green_kolka_alarm" then o = nil end
			if o and o.BaseObj == "C6L1_Car_doska_green_nogib" then o = nil end
			if o and o.BaseObj == "C6L1_Car_doska_red" then o = nil end
			if o and o.BaseObj == "C6L1_Car_doska_red_alarm" then o = nil end
			if o and o.BaseObj == "C6L1_Car_doska_red_nogib" then o = nil end
			if o and o.BaseObj == "C6L1_Car_mord_blue" then o = nil end
			if o and o.BaseObj == "C6L1_Car_mord_blue_GIB" then o = nil end
			if o and o.BaseObj == "C6L1_Car_mord_blue_nogib" then o = nil end
			if o and o.BaseObj == "C6L1_Car_mord_brown" then o = nil end
			if o and o.BaseObj == "C6L1_Car_mord_brown_nogib" then o = nil end
			if o and o.BaseObj == "C6L1_Car_pissan_white" then o = nil end
			if o and o.BaseObj == "C6L1_Car_pissan_white_kolka" then o = nil end
			if o and o.BaseObj == "C6L1_Car_pissan_white_nogib" then o = nil end
			if o and o.BaseObj == "C6L1_Car_pissan_yellow" then o = nil end
			if o and o.BaseObj == "C6L1_Car_pissan_yellow_gib" then o = nil end
			if o and o.BaseObj == "C6L1_Car_pissan_yellow_nogib" then o = nil end
			if o and o.BaseObj == "C6L1_drabinka" then o = nil end
			if o and o.BaseObj == "C6L3_cokol" then o = nil end
			if o and o.BaseObj == "C6L3_statua" then o = nil end
			if o and o.BaseObj == "C6L6_kula" then o = nil end
			if o and o.BaseObj == "C6L6_palpion" then o = nil end
			if o and o.BaseObj == "C6L6_palpoziom" then o = nil end
			if o and o.BaseObj == "C6L6_palpoziomPAM" then o = nil end
			if o and o.BaseObj == "C6L9_Wisiorki" then o = nil end
			if o and o.BaseObj == "C6L9_WisiorkiB" then o = nil end
			if o and o.BaseObj == "C6L9_WisiorkiC" then o = nil end
			if o and o.BaseObj == "C6L9_WisiorkiD" then o = nil end
			if o and o.BaseObj == "C7L1_ostrza" then o = nil end
			if o and o.BaseObj == "Cat_bridge1" then o = nil end
			if o and o.BaseObj == "Chest" then o = nil end
			if o and o.BaseObj == "ChestClosed" then o = nil end
			if o and o.BaseObj == "ChestOpen" then o = nil end
			--if o and o.BaseObj == "Coffin" then o = nil end
			if o and o.BaseObj == "Debris" then o = nil end
			if o and o.BaseObj == "Deska" then o = nil end
			if o and o.BaseObj == "deto_pack" then o = nil end
			if o and o.BaseObj == "DM_Wiatrak" then o = nil end
			if o and o.BaseObj == "Door" then o = nil end
			if o and o.BaseObj == "doorgrate" then o = nil end
			if o and o.BaseObj == "doors_opactwo" then o = nil end
			if o and o.BaseObj == "Drop" then o = nil end
			if o and o.BaseObj == "drzwi3" then o = nil end
			if o and o.BaseObj == "drzwidrewno" then o = nil end
			if o and o.BaseObj == "drzwi_fiz2" then o = nil end
			if o and o.BaseObj == "drzwi_fiz_2" then o = nil end
			if o and o.BaseObj == "Dzban1" then o = nil end
			if o and o.BaseObj == "Dzban2" then o = nil end
			if o and o.BaseObj == "dzbanek1" then o = nil end
			if o and o.BaseObj == "dzbanek2" then o = nil end
			if o and o.BaseObj == "dziura" then o = nil end
			if o and o.BaseObj == "FireExtinguisher" then o = nil end
			if o and o.BaseObj == "Gasoline_Can" then o = nil end
			if o and o.BaseObj == "gate" then o = nil end
			if o and o.BaseObj == "gazeta_kawalek1" then o = nil end
			if o and o.BaseObj == "gazeta_kawalek2" then o = nil end
			if o and o.BaseObj == "gazeta_kawalek3" then o = nil end
			if o and o.BaseObj == "gazeta_kawalek4" then o = nil end
			if o and o.BaseObj == "Hangman" then o = nil end
			if o and o.BaseObj == "Hangman_a" then o = nil end
			if o and o.BaseObj == "Hangman_b" then o = nil end
			if o and o.BaseObj == "kabina" then o = nil end
			if o and o.BaseObj == "kajdany" then o = nil end
			if o and o.BaseObj == "kamulec" then o = nil end
			if o and o.BaseObj == "kamulecKiller" then o = nil end
			if o and o.BaseObj == "kartka1" then o = nil end
			if o and o.BaseObj == "kartka2" then o = nil end
			if o and o.BaseObj == "kartka3" then o = nil end
			if o and o.BaseObj == "Katafalk" then o = nil end
			if o and o.BaseObj == "katap" then o = nil end
			if o and o.BaseObj == "klapa" then o = nil end
			if o and o.BaseObj == "klatka" then o = nil end
			if o and o.BaseObj == "klatkaCol" then o = nil end
			if o and o.BaseObj == "klocKiller" then o = nil end
			if o and o.BaseObj == "kolosdrzwi" then o = nil end
			if o and o.BaseObj == "Kontener" then o = nil end
			if o and o.BaseObj == "KontenerSmall" then o = nil end
			if o and o.BaseObj == "KontenerSmietnik" then o = nil end
			if o and o.BaseObj == "Kontener_duzy" then o = nil end
			if o and o.BaseObj == "Kontener_Maly1" then o = nil end
			if o and o.BaseObj == "Kontener_Maly2" then o = nil end
			if o and o.BaseObj == "Kontener_Maly3" then o = nil end
			if o and o.BaseObj == "krata_piwnica" then o = nil end
			if o and o.BaseObj == "Krzyz1" then o = nil end
			if o and o.BaseObj == "Krzyz2" then o = nil end
			if o and o.BaseObj == "Kubel" then o = nil end
			if o and o.BaseObj == "kupka" then o = nil end
			if o and o.BaseObj == "Lab_barrel" then o = nil end
			if o and o.BaseObj == "Lab_barrel_metal" then o = nil end
			if o and o.BaseObj == "lampaw" then o = nil end
			if o and o.BaseObj == "lampaw2" then o = nil end
			if o and o.BaseObj == "Lawka" then o = nil end
			if o and o.BaseObj == "linka" then o = nil end
			if o and o.BaseObj == "LoonyPark_Door" then o = nil end
			if o and o.BaseObj == "LoonyPark_RotGrate" then o = nil end
			if o and o.BaseObj == "MonkStatue" then o = nil end
			if o and o.BaseObj == "most" then o = nil end
			if o and o.BaseObj == "MovingBar" then o = nil end
			if o and o.BaseObj == "MovingBoulder" then o = nil end
			if o and o.BaseObj == "Paczka_gazety" then o = nil end
			if o and o.BaseObj == "Paletka" then o = nil end
			if o and o.BaseObj == "Pig" then o = nil end
			if o and o.BaseObj == "plyta_opactwo" then o = nil end
			if o and o.BaseObj == "polana" then o = nil end
			if o and o.BaseObj == "PosagRoma" then o = nil end
			if o and o.BaseObj == "Pudlo_karton" then o = nil end
			if o and o.BaseObj == "robo" then o = nil end
			if o and o.BaseObj == "robolong" then o = nil end
			if o and o.BaseObj == "skrzynia_duza" then o = nil end
			if o and o.BaseObj == "skrzynia_mala" then o = nil end
			if o and o.BaseObj == "skrzynia_metal" then o = nil end
			if o and o.BaseObj == "skrzynia_metal2" then o = nil end
			if o and o.BaseObj == "Skrz_Dynamite" then o = nil end
			if o and o.BaseObj == "Skrz_gornicza" then o = nil end
			if o and o.BaseObj == "Skrz_Opera" then o = nil end
			if o and o.BaseObj == "Smietnik" then o = nil end
			if o and o.BaseObj == "Stojak_1" then o = nil end
			if o and o.BaseObj == "Stojak_2" then o = nil end
			if o and o.BaseObj == "Stone" then o = nil end
			if o and o.BaseObj == "Stone_Big" then o = nil end
			if o and o.BaseObj == "Stone_Heavy" then o = nil end
			if o and o.BaseObj == "szmata1" then o = nil end
			if o and o.BaseObj == "szmata2" then o = nil end
			if o and o.BaseObj == "szmata3" then o = nil end
			if o and o.BaseObj == "szmata4" then o = nil end
			if o and o.BaseObj == "Truck" then o = nil end
			if o and o.BaseObj == "Urn" then o = nil end
			if o and o.BaseObj == "Vase" then o = nil end
			if o and o.BaseObj == "wajchaCOL" then o = nil end
			if o and o.BaseObj == "wazka" then o = nil end
			if o and o.BaseObj == "windapion" then o = nil end
			if o and o.BaseObj == "windapoziom" then o = nil end
			if o and o.BaseObj == "zamek" then o = nil end
			if o and o.BaseObj == "zwis" then o = nil end
...
function Game:OnPlay(firstTime)
	...
	self.Active = true
	if firstTime then
		if Player then --and self.GMode == GModes.SingleGame
	...
	if Lev.OnPlay then
		...
		-- STOP MP BREAKING
		local tempplayer = false
		if not Player then Player = {} Player.Ammo = {} tempplayer = true end
		Lev:OnPlay(firstTime)
		-- We should take 'Player' and apply to all. But we don't because we are lazy
		if tempplayer then Player = nil end
...
function Game_Tick3(delta) -- after worldtick
	if Cfg.Interpolation==1 or Cfg.Interpolation==2 or Cfg.Interpolation==3 then Game:InterpolateWorld(delta) end
	if Game.Active then
...
function Game:UpdateViewFromPlayer()
	...
	if not Player or not Player._Entity or NET.IsPlayingRecording()  then return end --or CONSOLE.DemoIsPlaying()
...
function Game:ShowHide(ents)
	if Player and Player._Entity then
		ENTITY.RemoveFromIntersectionSolver(Player._Entity)
	end
	for i,entity in ents do
		ENTITY.RemoveFromIntersectionSolver(i)
	end
	for i,entity in ents do
		local obj = EntityToObject[i]

		--local dx,dy,dz = ENTITY.GetPosition(i)
		if obj and obj._Class == "CPlayer" then
			local dx,dy,dz = ENTITY.PO_GetPawnHeadPos(i)

			local cx,cy,cz = CAM.GetPos()
			local a = WORLD.LineTrace(cx,cy,cz,dx,dy+2,dz)
			local b = WORLD.LineTrace(cx,cy,cz,dx,dy+1,dz)
			local c = WORLD.LineTrace(cx,cy,cz,dx,dy,dz)
			if (Player and i ~= Player._Entity) then
				if not a or not b or not c then
					if not (obj and obj._Rst and tonumber(obj._Rst) > 0) then
						ENTITY.EnableDraw(i,true,true)
					end
					Game.shown = Game.shown + 1
				else
					ENTITY.EnableDraw(i,false,false)
	...
	for i,entity in ents do
		ENTITY.AddToIntersectionSolver(i)
	end
end